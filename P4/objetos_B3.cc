...
vertices[2].x=-1;vertices[2].y=0;vertices[2].z=1;
vertices[3].x=-1;vertices[3].y=0;vertices[3].z=-1;
vertices[4].x=1.2;vertices[4].y=1;vertices[4].z=1.2;
vertices[5].x=1.2;vertices[5].y=1;vertices[5].z=-1.2;
vertices[6].x=-1.2;vertices[6].y=1;vertices[6].z=1.2;
vertices[7].x=-1.2;vertices[7].y=1;vertices[7].z=-1.2;
vertices[8].x=0;vertices[8].y=3;vertices[8].z=0;


caras.resize(16);
caras[0]._0=0;caras[0]._1=1;caras[0]._2=4;
caras[1]._0=1;caras[1]._1=4;caras[1]._2=5;
caras[2]._0=2;caras[2]._1=0;caras[2]._2=6;
caras[3]._0=0;caras[3]._1=6;caras[3]._2=4;
caras[4]._0=2;caras[4]._1=6;caras[4]._2=7;
caras[5]._0=3;caras[5]._1=2;caras[5]._2=7;
caras[6]._0=3;caras[6]._1=7;caras[6]._2=5;
caras[7]._0=3;caras[7]._1=5;caras[7]._2=1;
caras[8]._0=0;caras[8]._1=1;caras[8]._2=2;
caras[9]._0=3;caras[9]._1=1;caras[9]._2=2;
caras[10]._0=4;caras[10]._1=6;caras[10]._2=5;
caras[11]._0=6;caras[11]._1=5;caras[11]._2=7;
caras[12]._0=4;caras[12]._1=5;caras[12]._2=8;
caras[13]._0=4;caras[13]._1=6;caras[13]._2=8;
caras[14]._0=7;caras[14]._1=6;caras[14]._2=8;
caras[15]._0=7;caras[15]._1=8;caras[15]._2=8;
}

void _prueba::parametros(vector<_vertex3f> perfil, int num, int tipo, int tapa_in, int tapa_su)
{
...
glRotatef(90, 0, 0, 1);
glRotatef(90, 1, 0, 0);
aleron_trasero_base_drch.draw(modo, r, g, b, grosor);
glPopMatrix();
...
apendice.draw(modo, r, g, b, grosor);
glPopMatrix();
...
glRotatef(90, 0, 0, 1);
glRotatef(90, 1, 0, 0);
aleron_delantero_base_izq.draw(modo, r, g, b, grosor);
glPopMatrix();
...
glRotatef(90, 0, 0, 1);
glRotatef(90, 1, 0, 0);
aleron_delantero_base_drch.draw(modo, r, g, b, grosor);
glPopMatrix();
};