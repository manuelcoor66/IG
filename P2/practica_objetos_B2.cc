...
// objetos
_cubo cubo(0.4);
_piramide piramide(0.4,0.85);
_objeto_ply  ply; 
_rotacion rotacion; 
_extrusion *extrusion;
_cilindro cilindro(0.5, 1, 30);
_cono cono(1, 1, 20);
_esfera esfera(1.0, 20, 10);
...
switch (t_objeto){
	...
	case PIRAMIDE: piramide.draw(modo,1.0,0.0,0.0,5);break;
		...
		case CILINDRO: cilindro.draw(modo, 0.5, 0.1, 1.0, 0.19);break;
		case CONO: cono.draw(modo, 1.0, 0.6, 0.0, 5);break;
		case ESFERA: esfera.draw(modo, 0.5, 0.1, 1.0, 0.19);break;
}
}
...
switch (toupper(Tecla1)){
	...
	case '4':modo=SOLID_COLORS;break;
		...
		case 'A':t_objeto=CILINDRO;break;
		case 'S':t_objeto=CONO;break;
		case 'D':t_objeto=ESFERA;break;
	}
glutPostRedisplay();
}
